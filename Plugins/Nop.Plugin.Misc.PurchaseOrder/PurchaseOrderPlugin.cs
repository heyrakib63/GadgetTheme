...
public class PurchaseOrderPlugin : BasePlugin
{
    ...
    private Dictionary<string, string> GetLocaleResources()
    {
        return new Dictionary<string, string>
        {
            ...
            ["Admin.PurchaseOrder.Fields.Name.Required"] = "Name is Required",
            ["Admin.PurchaseOrder.Fields.Email"] = "Email",
            ["Admin.PurchaseOrder.Fields.Email.Hint"] = "Enter PurchaseOrder Email.",
            ["Admin.PurchaseOrder.Fields.Email.Required"] = "Email is Required",
            ["Admin.PurchaseOrder.Fields.Address"] = "Address",
            ["Admin.PurchaseOrder.Fields.Address.Hint"] = "Enter PurchaseOrder Address.",
            ["Admin.PurchaseOrder.Fields.Address.Required"] = "Address is Required",
            ["Admin.PurchaseOrder.List.Name"] = "Name",
            ["Admin.PurchaseOrder.List.Email"] = "Email",
            ["Admin.PurchaseOrder.List.Name.Hint"] = "Search by PurchaseOrder Name",
            ["Admin.PurchaseOrder.List.Email.Hint"] = "Search by Employee Email",
            ["Admin.PurchaseOrder.Info"] = "PurchaseOrder Info",
            ["Admin.PurchaseOrder.EditPurchaseOrderDetails"] = "Edit PurchaseOrder Details",
            ["Admin.PurchaseOrder.Updated"] = "PurchaseOrder Updated Successfully",
            ["Admin.PurchaseOrder.Deleted"] = "Deleted succusfully",
            ["Admin.PurchaseOrder.Added"] = "Created Successfully",
            ["Admin.Catalog.Products.ProductPurchaseOrder.SaveBeforeEdit"] = "You need to save the product before you can link a PurchaseOrder for this product page.",
        };
    }
